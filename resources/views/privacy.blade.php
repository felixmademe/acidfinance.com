...
@section( 'content' )
    ...
    <p>Acid Finance ("us", "we", or "our") operates the https://acidfinance.com website and the Acid Finance mobile application (hereinafter referred to as the "Service").</p>

    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy is managed by the  for Acid Finance is <a href="https://termsfeed.com/privacy-policy/generator/">TermsFeed's Privacy Policy Generator</a>.</p>
    ...
    <ul>
        <li>
            <p><strong>Service</strong></p>
                    <p>Service means the https://acidfinance.com website and the Acid Finance mobile application operated by Acid Finance</p>
                </li>
        <li>
    ...
    <p>Acid Finance uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>Acid Finance will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

    <h2>Disclosure Of Data</h2>

    <h3>Legal Requirements</h3>
    <p>Acid Finance may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Acid Finance</li>
